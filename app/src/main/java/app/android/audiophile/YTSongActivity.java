...
public class YTSongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ytsong);
        ...
        try {
            ...
            img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent vidIntent = new Intent(YTSongActivity.this, MusicPlayerActivity.class);
    ...
    public class WikiSearchAsyncTask extends AsyncTask<URL, Integer, String>{
        ...
        protected void onPostExecute(String result2) {
            Intent profIntent = new Intent(YTSongActivity.this, HomeActivity.class);
