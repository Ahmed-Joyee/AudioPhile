...
abstract public class MoveCallBack extends ItemTouchHelper.Callback {
    ...
    MoveCallBack(ItemTouchHelperContract adapter, Context context) {
        Adapter = adapter;
        mContext = context;
        mBackground = new ColorDrawable();
        backgroundColor = Color.parseColor("#85586F");
